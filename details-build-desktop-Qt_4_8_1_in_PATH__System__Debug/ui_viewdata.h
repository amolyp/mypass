...
**
** Created: Mon Nov 2 17:21:36 2015
...
public:
    ...
    void setupUi(QDialog *ViewData)
    {
        ...
        tbUpdateIssue->setGeometry(QRect(540, 64, 98, 27));
    ...
    void retranslateUi(QDialog *ViewData)
    {
        ...
        tbUpdateIssue->setText(QApplication::translate("ViewData", "Update Verify", 0, QApplication::UnicodeUTF8));
        gbSearch->setTitle(QString());
        rbCust->setText(QApplication::translate("ViewData", "Cust Name", 0, QApplication::UnicodeUTF8));
